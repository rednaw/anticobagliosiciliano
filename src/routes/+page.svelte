...
<section class="section about">
	<div class="container about-grid">
		<Reveal>
			...
			<h2>Accoglienza autentica tra pietra, agrumi e ulivi secolari</h2>
		</Reveal>
		<Reveal delay={120}>
			<p>
				Antico Baglio Siciliano è una struttura ricettiva immersa nella natura e nella storia della
				Sicilia occidentale. Offriamo un’accoglienza genuina, ambienti confortevoli e un’atmosfera
				rilassante — il ritmo lento del baglio, a pochi minuti dal mare di Balestrate.
			</p>
		</Reveal>
	</div>
</section>
	...
	<div class="container">
		...
		<div class="house-list">
			{#each houses as house, i}
				<Reveal delay={i * 80}>
					<a class="house" href={resolve(`/case/${house.slug}`)}>
...
<section class="section places">
	<div class="container">
		...
		<Reveal>
			<p class="places-cta">
				<a class="btn" href={resolve('/dintorni')}>Tutti gli imperdibili</a>
			</p>
		</Reveal>
	</div>
</section>
...
<section class="cta">
	<div class="container cta-inner">
		<Reveal>
			...
			<a class="btn btn-light" href={resolve('/contatti')}>Richiesta disponibilità</a>
		</Reveal>
	</div>
</section>
